...
/*!*****************************************************!*\
  !*** ./node_modules/apollo-boost/lib/bundle.esm.js ***!
  \*****************************************************/
/*! exports provided: HttpLink, gql, default */
...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module 'apollo-link'");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-cache-inmemory'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module 'apollo-cache-inmemory'");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link-http'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module 'apollo-link-http'");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link-error'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'graphql-tag'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module 'graphql-tag'");
!(function webpackMissingModule() { var e = new Error("Cannot find module 'ts-invariant'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var DefaultClient = function (_super) {
  !(function webpackMissingModule() { var e = new Error("Cannot find module 'tslib'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(DefaultClient, _super);
  ...
  function DefaultClient(config) {
    ...
    if (config) {
      ...
      if (diff.length > 0) {
         false || !(function webpackMissingModule() { var e = new Error("Cannot find module 'ts-invariant'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).warn('ApolloBoost was initialized with unsupported options: ' + ("" + diff.join(' ')));
      }
    }
    ...
    var cache = config.cache;
     false ? undefined : !(function webpackMissingModule() { var e = new Error("Cannot find module 'ts-invariant'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(!cache || !cacheRedirects, 'Incompatible cache configuration. When not providing `cache`, ' + 'configure the provided instance with `cacheRedirects` instead.');

    if (!cache) {
      cache = cacheRedirects ? new !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-cache-inmemory'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
        cacheRedirects: cacheRedirects
      }) : new !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-cache-inmemory'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
    }

    var errorLink = errorCallback ? !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link-error'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(errorCallback) : !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link-error'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function (_a) {
      ...
      if (graphQLErrors) {
        graphQLErrors.map(function (_a) {
          var message = _a.message,
              ...
              path = _a.path;
          return  false || !(function webpackMissingModule() { var e = new Error("Cannot find module 'ts-invariant'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).warn("[GraphQL error]: Message: " + message + ", Location: " + (locations + ", Path: " + path));
        });
      }

      if (networkError) {
         false || !(function webpackMissingModule() { var e = new Error("Cannot find module 'ts-invariant'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).warn("[Network error]: " + networkError);
      }
    });
    var requestHandler = request ? new !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function (operation, forward) {
      return new !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(function (observer) {
        var handle;
    ...
    var httpLink = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link-http'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
      uri: uri || '/graphql',
      fetch: fetch,
    ...
    var link = !(function webpackMissingModule() { var e = new Error("Cannot find module 'apollo-link'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).from([errorLink, requestHandler, httpLink].filter(function (x) {
      return !!x;
    }));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module './useQuery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module './useQuery'");
!(function webpackMissingModule() { var e = new Error("Cannot find module './useMutation'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module './useMutation'");
!(function webpackMissingModule() { var e = new Error("Cannot find module './ApolloContext'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module './ApolloContext'");
!(function webpackMissingModule() { var e = new Error("Cannot find module './SuspenseSSR'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module './SuspenseSSR'");
!(function webpackMissingModule() { var e = new Error("Cannot find module './getMarkupFromTree'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module './getMarkupFromTree'");
!(function webpackMissingModule() { var e = new Error("Cannot find module './useSubscription'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
throw new Error("Cannot find module './useSubscription'");
