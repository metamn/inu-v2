...
const HeaderIcons = props => {
  ...
  const thumbIconStatus = [-1, -2].includes(activeCategory) ? "inactive" : "active";
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(Container, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33
...
const Home = () => {
  ...
  const _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(0),
        ...
        setActiveSlide = _useState8[1]; // Is the slideshow active?
  ...
  const _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(false),
        ...
        slideshowActive = _useState10[0],
        setSlideshowActive = _useState10[1]; // How to display images
  ...
  const _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(0),
        ...
        displayMode = _useState12[0],
        setDisplayMode = _useState12[1]; // Previous image display mode
  // - this is used in the category icon click
  // - it restores either the thumb view or the slider view ...
  // - ...as it were before the click


  const _useState13 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(0),
        ...
        previousDisplayMode = _useState14[0],
        setPreviousDisplayMode = _useState14[1]; // Theming
  //
  ...
  const prefersDarkMode = Object(_hooks__WEBPACK_IMPORTED_MODULE_7__["usePrefersDarkMode"])(); // Get the starter color scheme

  const starterColorScheme = typeof currentThemeSaved !== "undefined" ? currentThemeSaved : prefersDarkMode ? "dark" : "light"; // Set up the theme context
  ...
  themeContext = Object(_themes_default_js__WEBPACK_IMPORTED_MODULE_6__["switchThemeTo"])(starterColorScheme); // Use the theme
  ...
  const thumbIconClickHandler = () => {
    ...
    if ([-1, -2].includes(activeCategory)) return; // Change the display mode
  ...
  const toggleTheme = () => {
    const newTheme = Object(_themes_default_js__WEBPACK_IMPORTED_MODULE_6__["switchThemeFrom"])(currentTheme.colorScheme);
...
const Container = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div(_templateObject(), _Cursor__WEBPACK_IMPORTED_MODULE_5__["CursorPointer"], props => props.size && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(_templateObject2(), props.size, props.size, props.size), props => props.className.includes("active") && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(_templateObject3()), props => props.className.includes("inactive") && props.theme.colors.inactive && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(_templateObject4(), props.theme.colors.inactive), props => props.className.includes("hidden") && Object(styled_components__WEBPACK_IMPORTED_MODULE_3__["css"])(_templateObject5()));
...
const Slider = props => {
  const width = props.width,
        ...
        slideshowActive = props.slideshowActive; // Refs to each slide
...
const useMedia = (queries, values, defaultValue) => {
  ...
  const mediaQueryLists = queries.map(q => window.matchMedia(q)); // Get index of first media query that matches
...
function usePrefersDarkMode() {
  return Object(_useMedia__WEBPACK_IMPORTED_MODULE_0__["default"])(["(prefers-color-scheme: dark)"], [true], false);
}
...
/*!*******************************!*\
  !*** ./src/themes/default.js ***!
  \*******************************/
/*! exports provided: getTheme, switchThemeFrom, switchThemeTo, ThemeContext */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "switchThemeTo", function() { return switchThemeTo; });
...
const ThemeContext = react__WEBPACK_IMPORTED_MODULE_0___default.a.createContext(switchThemeTo("light"));
